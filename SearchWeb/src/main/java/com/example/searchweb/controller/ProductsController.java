...
import com.example.searchweb.service.ProductsService;
...
public class ProductsController {
    ...
    @GetMapping("/dessearch")
    public List<Products> dessearchProducts(@RequestParam String keyword){
        List<Products> res = productsService.searchProductsByDescription(keyword);
